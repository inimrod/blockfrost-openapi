...
export interface paths {
    ...
    "/havoc/staking/submit": {
         ...
         */
        post: {
            /** @description The transaction to submit, serialized in CBOR. Plus the inputs dumped by Helios tx builder. */
            requestBody: {
                content: {
                    /**
                     * @example {
    ...
    "/havoc/voq-drop/submit": {
         ...
         * @description Submit VOQ token drop claim txs
         */
        post: {
            /** @description The transaction to submit, serialized in CBOR. Plus the inputs dumped by Helios tx builder. */
            requestBody: {
    ...
    "/havoc/wallets/verify-hw": {
        /**
         * Submit signed wallet verification message to confirm request initiated in Discord
         * @description Submit signed wallet verification message to confirm request initiated in Discord
         */
        post: {
            /** @description The hardware-wallet-signed dummy tx containing the verification message package. */
            requestBody: {
                content: {
                    /**
                     * @example {
    ...
    "/havoc/s2/mint": {
        /**
         * Mint Havoc Worlds Season 2 NFTs
         * @description Submit txs to mint Havoc Worlds Season 2
         */
        post: {
    ...
    "/havoc/s2/shuffle": {
        /**
         * Shuffle Havoc Worlds Season 2 NFTs
    ...
    "/dtknzr/metadata/{asset}": {
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    content: {
                        "application/json": components["schemas"]["asset_metadata"];
                    };
                };
                400: components["responses"]["400"];
                403: components["responses"]["403"];
    ...
    "/dtknzr/withdraw": {
        /**
         * Withdraw earned referral commissions from Detokenizer txs
         * @description Submit commission withdrawal txs
         */
        post: {
            /** @description The transaction to submit, serialized in CBOR. Plus the inputs dumped by Helios tx builder. */
            requestBody: {
    ...
    "/validate-sgd-msg": {
        /**
         * Validate user-submited signedData
